const Story = require("../../model/blogmodels/story");
const paginate = require("express-paginate");
const Comment = require("../../model/blogmodels/comment");
...
const getOne = async (req, res) => {
  try {
    let item = await Story.findByIdAndUpdate(req.params.id, {
      //this is for increamenting the viewCount field  $inc is Increament
      $inc: { viewsCount: 1 },
    }).populate("category", "title");
    // this means if item is story, fectch comments of story
    if (item) {
...
// the top story is based on views
