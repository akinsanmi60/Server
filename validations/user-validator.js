...
const validationRules = () => {
    return [
        check("firstname").trim().isLength({ min: 1, max: 20 }).withMessage("Name must be between 1 and  20 characters"),
        check("lastname").trim().isLength({ min: 1, max: 20 }).withMessage("Name must be between 1 and 20 characters"),
